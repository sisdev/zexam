              ...
              <a href="index.php" class="navbar-brand"><img src="images/logo.png" alt="Sisoft Learning" title="Sisoft Learning" width="230" /></a>
                        ...
                        <div class="navbar-collapse collapse" id="templatemo-nav-bar">
							...
							if(isset($_POST['login']) && empty($_SESSION['login']))
							{
									...
									$record=mysql_query("select username,userpass from users where username='$lemail' and userpass='$lpass' ");
						...
						/// NEED to VERIFY IF USER IS ALREADY REGISTERED ----	  
							...
							$record=mysql_query("select username,userphone from users where username='$remail' and userpass='$rpass1' ");
							$name=mysql_fetch_array($record);
							$count=mysql_num_rows($record);
							if($count==1)
							{
